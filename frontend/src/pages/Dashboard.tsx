// ────────────────────────────────────────────────────────────────────────────
// src/pages/Dashboard.tsx — RESPONSIVE VERSION WITH LOGO & MANUAL REDIRECTION
// ────────────────────────────────────────────────────────────────────────────
...
export default function Dashboard() {
  ...
  const handleCleanComplete = (
    ...
    setLog(appliedLog)
    setCelebrate(true)
    // Automated view redirection removed completely to keep you on the screen!
  }
  ...
  return (
    <div className="min-h-screen bg-[#0a0b0f] flex flex-col lg:flex-row text-gray-100">
      ...
      <div className="flex-1 min-w-0 flex flex-col h-auto lg:h-screen overflow-y-auto">
        {/* Success Alert Toast with Manual Navigation Action */}
        <AnimatePresence>
          {celebrate && (
            <motion.div
            ...
            >
              <div className="flex items-start justify-between w-full">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">Your dataset has been structured and optimized successfully.</p>
                </div>
                <button 
              ...
              <button
                ...
                className="w-full text-center py-2 px-3 rounded-lg text-xs font-semibold bg-green-500/10 hover:bg-green-500/20 text-green-400 border border-green-500/20 transition-all shadow-md animate-pulse"
              >
